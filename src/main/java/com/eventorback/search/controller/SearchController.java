...
//
// 	@GetMapping("/posts")
// 	public ResponseEntity<Page<SearchPostsResponse>> searchPosts(
// 		@PageableDefault(page = 1, size = 10) Pageable pageable, @RequestParam(required = false) String categoryName,
// 		@RequestParam String keyword) {
// 		return ResponseEntity.status(HttpStatus.OK)
// 			.body(elasticSearchService.searchPosts(pageable, categoryName, keyword));
// 	}
//
// 	// @GetMapping("/writers")
