...
public class ReportTypeController {
	...
	@AuthorizeRole("admin")
	@GetMapping("/paging")
	public ApiResponse<Page<ReportTypeDto>> getReportTypes(@PageableDefault(page = 1, size = 10) Pageable pageable) {
		return ApiResponse.createSuccess(reportTypeService.getReportTypes(pageable));
	}

	@GetMapping("/{reportTypeId}")
	public ApiResponse<ReportTypeDto> getReportType(@PathVariable Long reportTypeId) {
		return ApiResponse.createSuccess(reportTypeService.getReportType(reportTypeId));
	}

	@PostMapping
	public ApiResponse<Void> createReportType(
	...
	public ApiResponse<Void> updateReportType(@PathVariable Long reportTypeId,
		@RequestBody ReportTypeDto request) {
	...
	public ApiResponse<Void> deleteReportType(@PathVariable Long reportTypeId) {
