...
public class UserStopController {
	...
	@AuthorizeRole("admin")
	@GetMapping("/paging")
	public ApiResponse<Page<GetUserStopResponse>> getUserStops(
	...
	public ApiResponse<UserStopDto> getUserStop(@PathVariable Long userStopId) {
		return ApiResponse.createSuccess(userStopService.getUserStop(userStopId));
	}

	@AuthorizeRole("admin")
	@GetMapping("/users")
	public ApiResponse<List<GetUserStopByUserIdResponse>> getUserStopsByUserId(@RequestParam Long userId) {
		return ApiResponse.createSuccess(userStopService.getUserStopsByUserId(userId));
	}

	@AuthorizeRole("admin")
	@PostMapping
	public ApiResponse<Void> createUserStop(
	...
	public ApiResponse<Void> deleteUserStop(@PathVariable Long userStopId) {
